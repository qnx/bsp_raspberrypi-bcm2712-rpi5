...
void ksnprintf(char *buff, const size_t num, const char *fmt,... );
...
#ifndef HYPINFO_VIRT_SET
#define HYPINFO_VIRT_SET(val)   ((_Uint64t)(val) << 56)
#endif

#ifndef HYPINFO_VIRT_GET
#define HYPINFO_VIRT_GET(val)   ((val) >> 56)
#endif

#ifndef HYPINFO_VIRT_MASK
#define HYPINFO_VIRT_MASK       HYPINFO_VIRT_SET(0xff)
#endif

#ifndef HYPINFO_VIRT_VMX
#define HYPINFO_VIRT_VMX    0UL
#endif

#ifndef HYPINFO_VIRT_SVM
...
void         arch_hypervisor_syspage_init(struct hypinfo_entry *sysp_hypinfo);
