...
int i2c_master_getfuncs(i2c_master_funcs_t *funcs, int tabsize)
{
    I2C_ADD_FUNC(i2c_master_funcs_t, funcs,
            init, dwc_i2c_init, tabsize);
    I2C_ADD_FUNC(i2c_master_funcs_t, funcs,
            fini, dwc_i2c_fini, tabsize);
    I2C_ADD_FUNC(i2c_master_funcs_t, funcs,
            send, dwc_i2c_send, tabsize);
    I2C_ADD_FUNC(i2c_master_funcs_t, funcs,
            recv, dwc_i2c_recv, tabsize);
    I2C_ADD_FUNC(i2c_master_funcs_t, funcs,
            set_slave_addr, dwc_i2c_set_slave_addr, tabsize);
    I2C_ADD_FUNC(i2c_master_funcs_t, funcs,
            set_bus_speed, dwc_i2c_set_bus_speed, tabsize);
    I2C_ADD_FUNC(i2c_master_funcs_t, funcs,
            version_info, dwc_i2c_version_info, tabsize);
    I2C_ADD_FUNC(i2c_master_funcs_t, funcs,
            driver_info, dwc_i2c_driver_info, tabsize);
    return 0;
}
