...
#define I2C_MEM_SIZE    0x1000
#define I2C1_IRQ        0xa8    /* rpi5 */

int32_t dwc_i2c_probe_device(dwc_dev_t *dev)
{
    /*
     * for some historical reasons, we're filling default values here
     * assuming we're running on RPi5.
     *
     * for pci-type variants, redefine this function to fill out these:
     *   - dev->pbase
     *   - dev->map_size
     *   - dev->irq
     */
    dev->map_size = I2C_MEM_SIZE;
